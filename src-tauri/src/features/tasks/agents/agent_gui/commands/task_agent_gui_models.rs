...
use crate::features::tasks::agents::{AgentModelCapability, AgentSlashCommand};
...
pub struct Response {
    ...
    pub slash_commands: Vec<AgentSlashCommand>,
...
pub async fn task_agent_gui_models(
    ...
    Ok(Response {
        ...
        slash_commands: gui_agent.available_slash_commands(),
        ...
        capabilities: GuiAgentCapabilities {
            ...
            supports_slash_commands: !gui_agent.available_slash_commands().is_empty(),
        },
    })
}
